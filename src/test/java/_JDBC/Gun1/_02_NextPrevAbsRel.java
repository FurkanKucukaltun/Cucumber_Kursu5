...
public class _02_NextPrevAbsRel extends JDBCParent {
    ...
    public void nextPrev() throws SQLException {
        ...
        System.out.println("1. satır dilAdi= "+rs.getString(2)); // 2 column numarası english
                                                // rs.getstring(name)

        rs.next(); // 2. satır
        System.out.println("1. satır dilAdi= "+rs.getString(2)); // italian

        rs.next(); // 3. satır
        System.out.println("2. satır dilAdi= "+rs.getString(2)); // Japanese
    ...
    public void AbsoluteRelative() throws SQLException {
        ...
        rs.relative(5); // 15. satıra gider. Niye? çünkü en son bulunduğu yerden 5 ileri gider
        System.out.println("15-satır - title : " + rs.getString("title"));

        rs.absolute(-10); // sondan 10. satıra gider
