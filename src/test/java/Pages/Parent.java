...
public class Parent {
    ...
    public void clickFunction(WebElement element){
        ...
        element.click(); //eğer sayfada eleman gözükmediğinden dolayı tıklama çalışmazsa JavaScript üzerinden yapılabilir.
    }
    ...
    public void verifyContainsTextFunction(WebElement element, String value){
        ...
        //new Actions(GWD.getDriver()).keyUp(Keys.ESCAPE).perform();
    }
