...
public class _06_WriteInTheExcel {
    public static void main(String[] args) throws IOException {
        ...
        // Row yeniSatir= sheet.createRow(0); //sadece 1. satıra yazıyor
        Row yeniSatir= sheet.createRow(sheet.getPhysicalNumberOfRows()); // hep boş olan bir sonraki satıra geçiyor
        Cell yeniHucre=yeniSatir.createCell(0);
        yeniHucre.setCellValue("Merhaba DDDünya");
